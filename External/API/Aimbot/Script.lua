-- Open Sourced
-- Developed by abyss.lol
local v1 = {}

loadstring(game:HttpGet('https://raw.githubusercontent.com/Abyssal-lol/Orbit.cc/refs/heads/main/External/API/Aimbot/Configs/Config.lua'))()
